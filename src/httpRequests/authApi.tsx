...
export async function recoverPassword(credentials: RecoverPasswordCredentials): Promise<RegisterUserResponse> {
  try{
    const response = await fetch(`${apiBaseURL}/Account/register`, {
      method: 'POST',
      headers: {
...
//TODO
export async function forgotPassword(Email: string): Promise<RegisterUserResponse> {
  try{
    const response = await fetch(`${apiBaseURL}/Account/register`, {
      method: 'POST',
      headers: {
